...
void sendHTTP(String Actual_Time){
    ...
    String Message = httpsenddata + "?json={\"time\":\""+ Actual_Time + "\",\"id_gw\":\"" + "00000001" + "\",\"id_node\":\"" + "00000001" + "\",\"O3\":\"" + String(myDataSensor.o3) + "\",\"Temp\":\"" + String(myDataSensor.temp) + "\",\"Hum\":\"" + String(myDataSensor.hum)+ "\",\"Bat\":\"" + String(myDataSensor.bat)+"\"}"; 
    if (DEBUG){
      Serial.println(Message);
    }
    delay(5);
